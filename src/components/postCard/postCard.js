            ...
            <div key={_id} className="post-card padding-xl bd-radius-sm">
              <div className="flex-row gap flex-space-between ">
                <div className="flex-row gap">
                  <img className="user-avatar avatar-sm" src={avatar ? avatar:dummyAvatar} alt="profile" />
              ...
              {showComments && (
                <div className="flex-col gap padding-md">
                  {comments.map(({ _id, firstName, commentData,username, avatar }) => {
                    return (
                      <div
                        key={_id}
                      ...
                      >
                        ...
                        <p className="padding-md mg-left-xl">{commentData}</p>
                         <span className="close-btn">
                          ...
                          onClick={()=>upVoteCommentHandler(_id)}></i>
                          </span>
                          <span className="close-btn">
                          ...
                          ></i>
                           ...
                           <div className="close-btn preview-close-btn">
                            <i onClick={()=>removeCommentHandler(_id)}className="fa fa-trash align-end"></i>
                        </div>
                        :null }
                        </div>
                   </div>
                  ...
                  <div className="flex-row flex-center gap mg-xl">
                    ...
                    <div className="flex-row gap bd-btn width-lg bd-radius-sm">
                      ...
                      />
                      <button className="bd-remove padding-xl"onClick={commentHandler}>
                        POST
                      </button>
                    </div>
                  </div>
